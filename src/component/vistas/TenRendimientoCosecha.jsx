...
/*  const [datosRendiCose, setDatosRendiCose] = useState([]);
  const [error, setError] = useState(''); // ni idea de si es que funcione, esto era para  que el usuario vea un mensaje por si es que tiene un error al obtener los datos
  ...
  /*    if (!datosRendiCose) {  return <p>Cargando...</p>;  //esta o  Otra lógica de manejo de carga }  */
                ...
                <div /* className="grid-container" */ className='displa_flex'>
                    ...
                    <div className="table1">
                        <div className="tablivilil3" style={{'marginTop':'0px','marginBottom':'0px','height':'680px'}}>
                            <div className="search-container" >
                                <select style={{'marginLeft': 'auto','position': 'absolute', 'left': '10px','paddingLeft': '10px','paddingRight': '10px'}}  value={formatoDescarga} onChange={(e) => setFormatoDescarga(e.target.value)}>
                                    <option value="">Selecciona un formato</option>
                                    <option value="pdf">PDF</option>
                                    <option value="csv">CSV</option>
                                </select>
                            <button className='btn nav-link mb-2 separound_spas' style={{'marginLeft': 'auto','position': 'absolute', 'right': '100px','paddingLeft': '10px','paddingRight': '10px'}} 
