...
import { FaBars, FaAngleDown, FaAngleRight, FaUserPlus, FaHome, FaSignInAlt, FaSignOutAlt, FaPencilAlt } from "react-icons/fa";
      ...
      <div>
                ...
                <form onSubmit={handleSubmit}>
                  <div className=' class="mb-3 row'>
                    ...
                    <div className="col-sm-10">
                      <input className='form-control mb-3  ' type="text" value={nombre} minLength={6} maxLength={40}  onChange={(e) => setNombre(e.target.value)} />
                      <p >{nombre.length} </p>
                  ...
                  <div className=' class="mb-3 row'>
                    ...
                    <div className="col-sm-10">
                      <input className='form-control mb-3  ' type="text" value={rut} minLength={12} maxLength={12} onChange={handleChange} /* onChange={(e) => setRut(e.target.value)} */ />
                      <p>{rut.length} </p>
                    </div>
              ...
              {operadores.map((operador) => (
                <tr  key={operador.id} >
                  ...
                  {/*  <button type="button" onClick={() => eliminarOperador(operador.id)}>Eliminar</button> 
                    <button type="button" onClick={() => confirmarEliminar(operador.id)}>Eliminar</button> */}
        ...
        {mostrarModal && (
          <div className="modal">
            ...
            <button className="modal-close" onClick={() => setMostrarModal(false)}>X</button>
              ...
              <button type="button" className="btn btn-light btn-outline-danger" onClick={eliminarOperador}>Eliminar</button> {/* 
                <button type="button" onClick={() => eliminarOperador(operador.id)}>Eliminar</button>  */}
                <button type="button" className="btn btn-light btn-outline-dark" onClick={() => setMostrarModal(false)}>Cancelar</button>
              </div>
            </div>
          </div>
        )}
...
{/*
      <div className="container border">
        <h2 className='mb-3'>Agregar nuevos trabajadores</h2>
        <div className="form-group">  <label className='mb-3'>Nombre:</label>
          <input type="text" className="form-control mb-3" value={name} onChange={(e) => setName(e.target.value)} />  
        </div>
        <div className="form-group">  <label className='mb-3'>ID:</label>
          <input type="text" className="form-control mb-3" value={id} onChange={(e) => setId(e.target.value)} />  
        </div>
        <button className="btn btn-primary mb-3" onClick={handleAddWorker}>  Agregar  </button>
      </div> */}
      </div>
      </div>
